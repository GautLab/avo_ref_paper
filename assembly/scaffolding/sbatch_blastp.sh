#!/bin/bash
#SBATCH -J blastp		# jobname
#SBATCH -o blastp.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e blastp.e%A.%a		# error file name A is the jobid and a is the arraytaskid
...
QRY=pamericana_hass_gene_stranded.pep

#SWISSPROT_UNIPROT
MYDB=/gpool/databases/swissprot_2021_02/uniprot_sprot
OUTFILE=./blastoutput/$(basename ${QRY} .pep)_swissprot_blastp.outfmt6
...
#OUTFILE=./blastoutput/$(basename ${QRY} .pep)_uniref90.blastp.outfmt6
