#!/bin/bash
#SBATCH -J bwapnas		# jobname
#SBATCH -o bwapnas.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e bwapnas.e%A.%a		# error file name A is the jobid and a is the arraytaskid
#SBATCH -a 1-13	#24, 13		# start and stop of the array start-end
#SBATCH --nodes=1
#SBATCH -c 16
