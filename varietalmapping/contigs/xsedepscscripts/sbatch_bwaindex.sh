#!/bin/bash
#SBATCH -J bawindex             # jobname
#SBATCH -o bawindex.o%A.%a      # jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e bawindex.e%A.%a      # error file name A is the jobid and a is the arraytaskid
#SBATCH -a 6-6          # start and stop of the array start-end
#SBATCH --nodes=1
