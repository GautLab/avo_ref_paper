...
gcpp ${OPTIONS} $(basename ${REF} .fasta)_pbmm2.sorted.bam -r ${REF} -o $(basename ${REF} .fasta).variants.gff -o $(basename ${REF} .fasta).consensus.fasta -o $(basename ${REF} .fasta).consensus.fastq
