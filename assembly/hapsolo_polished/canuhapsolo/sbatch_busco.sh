#!/bin/bash
#SBATCH -J buscoanf		# jobname
#SBATCH -o buscoanf.o%A.%a	# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e buscoanf.e%A.%a	# error file name A is the jobid and a is the arraytaskid
...
#SBATCH -p p1,smallgc			# queue (partition) -- normal, development, largemem, etc.
