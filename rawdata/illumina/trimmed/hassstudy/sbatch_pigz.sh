#!/bin/bash
#SBATCH -J pigzhs             # jobname
#SBATCH -o pigzhs.o%A.%a      # jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e pigzhs.e%A.%a      # error file name A is the jobid and a is the arraytaskid
