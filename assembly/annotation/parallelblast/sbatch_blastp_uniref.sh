#!/bin/bash
#SBATCH -J blastpuniref		# jobname
#SBATCH -o blastpuniref.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e blastpuniref.e%A.%a		# error file name A is the jobid and a is the arraytaskid
#SBATCH -a 1200-2810			# start and stop of the array start-end
###SBATCH --nodes=1
...
#OUTFILE=./fstpeaksearch/blastoutput/$(basename ${QRY} .pep)_uniref90.blastp.outfmt6
OUTFILE=blastp_uniref/$(basename ${QRY} .pep)_uniref90.blastp.outfmt6
