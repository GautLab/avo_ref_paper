#!/bin/bash
#SBATCH -J bwagautlab		# jobname
#SBATCH -o bwagautlab.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e bwagautlab.e%A.%a		# error file name A is the jobid and a is the arraytaskid
