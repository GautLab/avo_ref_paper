#!/bin/bash
#SBATCH -J blastxswissprot		# jobname
#SBATCH -o blastxswissprot.o%A.%a		# jobname.o%j for single (non array) jobs jobname.o%A.%a for array jobs
#SBATCH -e blastxswissprot.e%A.%a		# error file name A is the jobid and a is the arraytaskid
...
OUTFILE=blastx_swissprot/$(basename ${QRY} .fasta)_swissprot_uniprot.blastx.outfmt6
