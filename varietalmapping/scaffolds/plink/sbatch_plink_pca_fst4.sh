...
##Plink output
#vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode.vcf.gz --plink --out $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode
#plink --file $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode --memory 30000 --threads ${CORES} --pca --out $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode.PCA
...
#Guatemalank3 Pop
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode.vcf.gz --keep ${POP5} --out $(basename ${VCF} .vcf.gz).noBAD.GUAK3 --recode --recode-INFO-all
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.GUAK3.recode.vcf
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.GUAK3.recode.vcf.gz --maf 0.05 --recode --recode-INFO-all --out $(basename ${VCF} .vcf.gz).noBAD.GUAK3.recodeall.maf
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.GUAK3.recodeall.maf.recode.vcf

#Lowland Pop
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode.vcf.gz --keep ${POP3} --out $(basename ${VCF} .vcf.gz).noBAD.LLD --recode --recode-INFO-all
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.LLD.recode.vcf
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.LLD.recode.vcf.gz --maf 0.05 --recode --recode-INFO-all --out $(basename ${VCF} .vcf.gz).noBAD.LLD.recodeall.maf
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.LLD.recodeall.maf.recode.vcf

#CA Domesticated Pop
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.recodeall.maf.recode.vcf.gz --keep ${POP4} --out $(basename ${VCF} .vcf.gz).noBAD.CAD --recode --recode-INFO-all
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.CAD.recode.vcf
vcftools --gzvcf $(basename ${VCF} .vcf.gz).noBAD.CAD.recode.vcf.gz --maf 0.05 --recode --recode-INFO-all --out $(basename ${VCF} .vcf.gz).noBAD.CAD.recodeall.maf
pigz -p ${CORES} $(basename ${VCF} .vcf.gz).noBAD.CAD.recodeall.maf.recode.vcf
